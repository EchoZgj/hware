...
public class StringUtil {
     ...
     * 字符编码转换
     * @param str			- 需要转换的字符串
     * @param oldCharSet	- 原来的编码方式
     * @param newCharSet	- 需要转换后的编码方式
     * @return str			- 编码转换后的字符串
     */
    public static String getCharSetStr(String str,
                                       String oldCharSet,
                                       String newCharSet) {
        if (str == "" || str == null) {
            return "";
     ...
     */
    public static String getEncoding(String src,
                                     String srcCharset,
                                     String objCharset) {
        try {
            if (src == null) {
    ...
    /**
     * 比较两字符串是否相同(不分大小写) 如果相同返回 equalsStr 反之返加 noEqualsStr 若有参数如果为null or ""
     * ,当前参数值视为 "" 处理.
     *
     * @param str
     * @param objStr
     ...
     * @return
     */
    public static String equalsIgnoreCase(String str,
                                          String objStr,
                                          String equalsStr,
                                          String noEqualsStr) {
        if (noEqualsStr == null) {
     ...
     * <code>'t'</code>.</p>
     *
     * <p>As of Lang 2.0, this calls {@link org.apache.commons.lang.StringEscapeUtils#escapeJava(String)}
     * behind the scenes.
     * </p>
     ...
     * @throws NullPointerException if str is <code>null</code>
     * @deprecated Use {@link org.apache.commons.lang.StringEscapeUtils#escapeJava(String)}
     ...
     * </ul>
     *
     * <p>For a word based algorithm, see {@link org.apache.commons.lang.WordUtils#swapCase(String)}.
     * A <code>null</code> input String returns <code>null</code>.</p>
     *
     * <pre>
     ...
     * @deprecated Use the relocated {@link org.apache.commons.lang.WordUtils#capitalize(String)}.
     *             Method will be removed in Commons Lang 3.0.
     */
